...
ActiveRecord::Schema[7.1].define(version: 2024_01_11_074240) do
  ...
  create_table "categories_tasks", charset: "utf8mb4", force: :cascade do |t|
    t.bigint "task_id"
  ...
  create_table "categories_users", charset: "utf8mb4", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "category_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
